...
# #   resource_group_name  = "${azurerm_resource_group.cleanair_datasources.name}"
...
# # resource "azurerm_resource_group" "cleanair_datasources" {
...
# #   resource_group_db    = "${azurerm_resource_group.databases.name}"
