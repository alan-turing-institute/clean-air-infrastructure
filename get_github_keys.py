...
def get_keys(datasource, rg_name="RG_CLEANAIR_DATASOURCES", rg_kv="RG_CLEANAIR_INFRASTRUCTURE"):
    ...
    logging.info("... please add a key called '%s' to the 'Deploy keys' section on GitHub (under clean-air-infrastructure > Settings > Deploy keys)", key_name)
    ...
    logging.info("    ensure that there is a webhook called %s", webhook_url)
