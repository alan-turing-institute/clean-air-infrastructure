...
def main():
    ...
    parser.add_argument("--trainend", type=str, default='2019-10-26T00:00:00',
    ...
    parser.add_argument("--predstart", type=str, default='2019-10-26T00:00:00',
    ...
    model_fitter.fit(max_iter=10, lengthscales=0.1, variance=0.1, minibatch_size=500, n_inducing_points=None)
