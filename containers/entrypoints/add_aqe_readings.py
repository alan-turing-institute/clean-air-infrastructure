...
from cleanair.parsers import AQEArgumentParser
...
def main():
    ...
    args = AQEArgumentParser(description="Get AQE sensor data").parse_args()
    ...
    try:
        aqe_writer = AQEWriter(end=args.end, nhours=args.nhours, secretfile=args.secretfile)
