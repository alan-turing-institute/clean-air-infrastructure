...
from cleanair.data_generators.scoot_generator import create_daily_readings_df
...
def test_outliers_removed(
    anomalous_scoot_df: pd.DataFrame,
...
def test_negative_readings_removed(
    negative_scoot_df: pd.DataFrame,
):  # pylint: disable=redefined-outer-name
