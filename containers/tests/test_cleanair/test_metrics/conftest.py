...
def result_df(
    ...
    dframe["instance_id"] = fake_instance.instance_id
    dframe["data_id"] = fake_instance.data_id
    return dframe
...
def metrics_calculator(fake_instance, secretfile, connection_class):
    ...
    return AirQualityMetrics(
        fake_instance.instance_id, secretfile=secretfile, connection=connection_class
    )
