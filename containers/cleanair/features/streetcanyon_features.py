...
from .feature_funcs import sum_area, min_, avg_
...
class StreetCanyonFeatures(StaticFeatures):
    ...
    def __init__(self, **kwargs):
        ...
        self.features = {
            ...
            "max_ratio_avg": {"type": "value", "feature_dict": {"ratio_avg": ["*"]}, 'aggfunc': avg_},
            "min_min_width": {"type": "value", "feature_dict": {"min_width": ["*"]}, 'aggfunc': min_},
            "avg_min_width": {"type": "value", "feature_dict": {"min_width": ["*"]}, 'aggfunc': avg_},
            "max_min_width": {"type": "value", "feature_dict": {"min_width": ["*"]}, 'aggfunc': avg_},
}
