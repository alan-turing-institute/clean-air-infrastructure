...
class SatelliteSite(Base):
    ...
    def build_box_ewkt(latitude, longitude, buff_size):
        ...
        corners = [[latitude - buff_size, longitude - buff_size],
...
class SatelliteDiscreteSite(Base):
    ...
    point_id = Column(UUID(as_uuid=True), ForeignKey("interest_points.meta_point.id"), nullable=False, primary_key=True)
