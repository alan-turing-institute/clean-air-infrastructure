...
def build_entry(feature_name, reading_tuple):
    ...
    """
    # Construct the appropriate entry and return it
    if feature_name == "museums":
        return UKMapMuseums.build_entry(reading_tuple)
    return None
...
class UKMapIntersections(Base):
    ...
    geom = Column(Geometry(geometry_type="GEOMETRYCOLLECTION", srid=4326, dimension=2, spatial_index=True))
