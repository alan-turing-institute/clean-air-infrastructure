...
import numpy as np
import pandas as pd
from .metrics import log_regression_scalar_metrics, log_binary_scalar_metrics
...
def collect_results_for_dataset(
    ex, model, data, dataset_name, prediction_fn, returns_ci, data_type
):
    XS = data["X"]
    ...
    if returns_ci:
        ...
        predictions = {"median": median, "ci_lower": ci_lower, "ci_upper": ci_upper}
        ...
        predictions = {"mu": pred_mu, "var": pred_var}
