...
<<<<<<< HEAD:containers/cleanair/cleanair/mixins/database_query_mixin.py
...
class ScootQueryMixin:
    ...
    def get_scoot_detectors(
        ...
        with self.dbcnxn.open_session() as session:
            ...
            return readings
=======
>>>>>>> 5f4663cef950153802e4469b312b64d3e8697843:containers/cleanair/cleanair/mixins/query_mixins/database_query_mixin.py
