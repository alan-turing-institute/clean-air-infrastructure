...
class JamcamTodayStatsView(Base):
    ...
    __table__ = create_materialized_view(
        ...
        select([
            ...
            func.date_trunc("day", JamCamVideoStats.video_upload_datetime).label("measurement_start_utc"),
        ])
        .where(
            JamCamVideoStats.video_upload_datetime >= func.date_trunc("day", current_timestamp())
        )
        .group_by(
