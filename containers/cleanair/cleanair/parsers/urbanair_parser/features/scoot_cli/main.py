...
# import time
import typer
from . import road_maps
from . import readings_to_roads
...
app = typer.Typer(help="Scoot feature processing")
app.add_typer(road_maps.app, name="roadmap")
app.add_typer(readings_to_roads.app, name="roadreadings")
