...
MODEL_TRAINING_X_PICKLE: Path = MODEL_DATA_CACHE / "x_training.pkl"
MODEL_TRAINING_Y_PICKLE: Path = MODEL_DATA_CACHE / "y_training.pkl"
MODEL_PREDICTION_X_PICKLE: Path = MODEL_DATA_CACHE / "x_prediction.pkl"
MODEL_PREDICTION_Y_PICKLE: Path = MODEL_DATA_CACHE / "y_prediction.pkl"
...
RESULTS_CACHE: Path = MODEL_CACHE / "results"
TRAINING_RESULTS_CSV: Path = MODEL_CACHE / "training_results.csv"
TRAINING_RESULTS_PICKLE: Path = MODEL_CACHE / "training_results.pkl"
FORECAST_RESULTS_CSV: Path = MODEL_CACHE / "test_results.csv"
FORECAST_RESULTS_PICKLE: Path = MODEL_CACHE / "test_results.pkl"
